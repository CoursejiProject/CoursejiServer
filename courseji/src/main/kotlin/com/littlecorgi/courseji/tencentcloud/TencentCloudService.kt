...
interface TencentCloudService {
     ...
     */
    fun compareFaceFromFile(studentId: Long, detectLiveFace: Boolean, picFile: MultipartFile): Float
     ...
     * @throws [com.littlecorgi.courseji.tencentcloud.DetectLiveFaceException] 活体检测失败
     */
    fun compareFaceFromURL(studentId: Long, detectLiveFace: Boolean, picURL: String): Float
     ...
     * @throws [com.littlecorgi.courseji.tencentcloud.DetectLiveFaceException] 活体检测失败
     */
    fun compareMaskFaceFromFile(studentId: Long, detectLiveFace: Boolean, picFile: MultipartFile): Float
     ...
     * @throws [com.littlecorgi.courseji.tencentcloud.DetectLiveFaceException] 活体检测失败
     */
    fun compareMaskFaceFromURL(studentId: Long, detectLiveFace: Boolean, picURL: String): Float
}